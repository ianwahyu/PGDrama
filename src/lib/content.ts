...
export const CONTENT_TYPES: Array<{ type: ContentType; label: string; href: string; accent: string }> = [
  { type: "dramas", label: "Short Drama", href: "/dramas", accent: "bg-pink-300" },
  { type: "anime", label: "Anime", href: "/anime", accent: "bg-primary-300" },
  { type: "moviebox", label: "MovieBox", href: "/moviebox", accent: "bg-yellow-500" },
  { type: "iqiyi", label: "iQIYI", href: "/iqiyi", accent: "bg-content-100" },
  { type: "wetv", label: "WeTV", href: "/wetv", accent: "bg-pink-500" },
  { type: "drakor", label: "DrakorIndo", href: "/drakor", accent: "bg-primary-500" }
];
